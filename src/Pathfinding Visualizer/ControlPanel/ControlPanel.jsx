              ...
              <div className="d-flex flex-row">
                <div
                  ...
                  style={{
                    width: "20px",
                    height: "20px",
                    outline: "1px solid rgba(255, 77, 141, 0.4)",
              ...
              <div className="d-flex flex-row">
                <div
                  ...
                  style={{
                    width: "20px",
                    height: "20px",
                    background: "linear-gradient(135deg, #ff99c8, #ff4d8d)",
                    boxShadow: "0 0 6px rgba(255, 77, 141, 0.6)",
                    marginRight: "10px",
                    borderRadius: "2px",
                  }}
                />
              ...
              <div className="d-flex flex-row">
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      "inset 0 0 4px #ffd6eb, 0 0 8px rgba(255, 47, 146, 0.9)",
                    marginRight: "10px",
                    borderRadius: "2px",
                  }}
                />
