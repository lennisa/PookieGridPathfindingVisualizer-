...
export default class PathfindingVisualizer extends Component {
  ...
  visulalizeAlgorithm = () => {
    ...
    isAlgoRunning = AlgorithmSelected;
    ...
    if (AlgorithmSelected === 1) {
      ...
      visitedNodesInOrder = bidirectionalBFS(
        grid,
        startNode,
        finishNode,
        allowedDirections
  ...
  toggleTheme = () => {
    if (theme === 1) {
      ...
      extraWallClass = "-dark";
      this.setState({});
      document.getElementById("wall-icon").style.backgroundColor = "#8f3d52";
      ...
      extraWallClass = "";
      this.setState({});
      document.getElementById("wall-icon").style.backgroundColor = "#b24c63";
